...
public class MonthAndDayRule1 extends ExtractionRule {

    protected Locale locale = Locale.US;
    protected double confidence = 0.8;
    private int priority = 5;
    private String ruleEn = "(\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY
            + "))[.]?[\\s]*[,]?[\\s]*(the[\\s]*)?((([1-2][0-9]|[3][0-1]|[0]?[1-9]))(th|st|nd)?)(of[\\s]*)?([\\s]*[,]?[\\s]*\\b([12][0-9]\\d\\d)\\b)?\\b";
    private String rule = "(\\b((([1-2][0-9]|[3][0-1]|[0]?[1-9]))" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY
            + "))[.]?([,]?[\\s]*\\b([12][0-9]\\d\\d)\\b)?\\b";
